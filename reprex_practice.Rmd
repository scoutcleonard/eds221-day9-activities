...
```{r}
df <- tribble(
  ~garment, ~yarn_wt, ~yarn_fiber,
  "Sweater", "aran_wt", "alpaca",
  "cowl", "worsted_wt", "Cashmere",
  "mittens", "fingering_wt", "Merino"
)
...
df_2 %>% 
  ggplot(aes(x = yardage, y = skeins)) +
  geom_point(aes(shape = garment), color = "blue")
```
